...
<div class="row">
    <div class="col-lg-12">
        <div class="page-header">
            <h1>Selamat Datang <small>{<?php echo $uname;?>}</h1>
        </div>
        <div id="demo"><!--ajax-->
        ...
        <script>
            function loadDoc() {
                var xhttp = new XMLHttpRequest(); //pendeklarasian var xhttp diisi nilai perintah XMLHttpRequest
                xhttp.onreadystatechange = function() { //jika sudah siap digunakan
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("demo").innerHTML = //mena
                        this.responseText;
                    }
                };
                xhttp.open("GET", "tambah.txt", true);
                xhttp.send();
            }
        </script>
<?php
