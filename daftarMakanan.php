			...
			<div class="row">
			    <div class="col-lg-12">
        			<div class="page-header">
            			...
            			<a href="tambahMakanan.php" class="btn btn-info btn-sm" role="button"><span class="glyphicon glyphicon-plus" id="addnew"> </span> Tambah Makanan</a>
					...
					<table class="table table-hover table-bordered">
						<thead>
							<tr>
								...
								<td><center>Menu Makanan</center></td>
						...
						<tbody>
							...
							<tr align="center">
								...
								<td><a href="resepMakanan.php?id=<?php echo $menu['no'];?>" class="btn btn-success btn-sm" role="button">
									...
									<a href="deletesql.php?id=<?php echo $menu['no'];?>" class="btn btn-danger btn-sm" role="button">
										<span class="glyphicon glyphicon-trash"> </span> Delete
									</a>
									<a href="edit.php?id=<?php echo $menu['no'];?>" class="btn btn-primary btn-sm" role="button">
